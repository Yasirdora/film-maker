            ...
            {ASPECT_RATIOS.map((ar) => {
                ...
                return (
                    <button
                        ...
                        className={`flex flex-1 flex-col items-center justify-center rounded-lg px-1 py-2 transition-colors ${
                            active
                                ? "bg-[#313135] shadow-sm"
                                : "hover:bg-white/[0.05]"
                        }`}
        ...
        >
            <span
                className={`flex h-5 w-5 items-center justify-center rounded-md transition-colors duration-150 ${
                    disabled
                        ? ""
                        : "group-hover/step:bg-white/10 group-active/step:bg-white/[0.14]"
                }`}
            >
                {children}
            </span>
