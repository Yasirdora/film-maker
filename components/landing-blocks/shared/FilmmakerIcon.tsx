interface FilmmakerIconProps {
  className?: string;
  width?: number;
  height?: number;
}

/** Static clapperboard mark used as the hero + section brand icon. */
export function FilmmakerIcon({ className, width = 72, height = 72 }: FilmmakerIconProps) {
  return (
    <svg
      className={className}
      width={width}
